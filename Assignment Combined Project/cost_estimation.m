function [ output ] = cost_estimation( tram_params, car_params, general_params, tram_simulation_output, car_simulation_output, fleet_info_output, do_print )
...
tram_drive_cycle_cost = drive_cycle_cost(tram_params, general_params, tram_simulation_output, do_print);
output.tram_drive_cycle_cost = tram_drive_cycle_cost;

if do_print
	fprintf('\n--Car round trip drive cycle cost calculation--\n');
end
car_drive_cycle_cost = drive_cycle_cost(car_params, general_params, car_simulation_output, do_print);
...
function [ output ] = drive_cycle_cost(vehicle_params, general_params, vehicle_simulation_output, do_print)
%% Cost of motor
if do_print
